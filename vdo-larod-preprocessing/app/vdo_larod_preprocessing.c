 ...
 *     ./usr/local/packages/vdo_larod_preprocessing/vdo_larod_preprocessing \
 *     /usr/local/packages/vdo_larod_preprocessing/model/mobilenet_v2_1.0_224_quant_edgetpu.larod \
 *     224 224 -c 4 -l /usr/local/packages/vdo_larod_preprocessing/label/imagenet_labels.txt
 */
